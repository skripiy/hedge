        ...
        try:
            async with self.async_session() as session:
                ...
                return {
                    ...
                    "api_key_a": config.api_key_a,
                    "api_secret_a": config.api_secret_a,
                    "api_key_b": config.api_key_b,
                    "api_secret_b": config.api_secret_b,
                    "leverage": config.leverage,
                    "order_type": config.order_type.value if config.order_type else "market",
